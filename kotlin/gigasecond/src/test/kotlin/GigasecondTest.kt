...
class GigasecondTest {
    ...
    fun modernTime() {
        ...
        assertEquals(LocalDateTime.of(2043, Month.JANUARY, 1, 1, 46, 40), gigaSecond)
    }
    ...
    fun afterEpochTime() {
        ...
        assertEquals(LocalDateTime.of(2009, Month.FEBRUARY, 19, 1, 46, 40), gigaSecond)
    }
    ...
    fun beforeEpochTime() {
        ...
        assertEquals(LocalDateTime.of(1991, Month.MARCH, 27, 1, 46, 40), gigaSecond)
    }
    ...
    fun withFullTimeSpecified() {
        ...
        assertEquals(LocalDateTime.of(2046, Month.OCTOBER, 2, 23, 46, 40), gigaSecond)
    }
    ...
    fun withFullTimeSpecifiedAndDayRollover() {
        ...
        assertEquals(LocalDateTime.of(2046, Month.OCTOBER, 3, 1, 46, 39), gigaSecond)
    }
